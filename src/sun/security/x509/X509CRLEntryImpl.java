...
public class X509CRLEntryImpl extends X509CRLEntry_YA {
    ...
    /**
     * Gets the serial number from this X509CRLEntry_YA,
    ...
    /**
     * Gets the revocation date from this X509CRLEntry_YA,
     ...
     * method in X509CRLEntry_YA. It is better performance-wise since it returns
     * cached values.
     */
    @Override
     ...
     * getRevocationReason method in X509CRLEntry_YA.
     */
    public static CRLReason getRevocationReason(X509CRLEntry_YA crlEntry) {
        try {
     ...
     * X509CRLEntry_YA.  In the returned set, each extension is
    ...
    /**
     * Utility method to convert an arbitrary instance of X509CRLEntry_YA
     * to a X509CRLEntryImpl. Does a cast if possible, otherwise reparses
     * the encoding.
     */
    public static X509CRLEntryImpl toImpl(X509CRLEntry_YA entry)
            throws CRLException {
