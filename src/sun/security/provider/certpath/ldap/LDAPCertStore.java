...
public class LDAPCertStore extends CertStoreSpi {
     ...
     * @throws CertStoreException       if an exception occurs
     */
    private Collection<X509CRL_YA> getCRLs(LDAPRequest request, String id,
        ...
        if (n == 0) {
            return Collections.<X509CRL_YA>emptySet();
        }

        List<X509CRL_YA> crls = new ArrayList<X509CRL_YA>(n);
    ...
    public synchronized Collection<X509CRL_YA> engineGetCRLs(CRLSelector selector)
        ...
        HashSet<X509CRL_YA> crls = new HashSet<X509CRL_YA>();
        ...
        for (Object nameObject : issuerNames) {
            ...
            Collection<X509CRL_YA> entryCRLs = Collections.<X509CRL_YA>emptySet();
