...
class CrlRevocationChecker extends PKIXCertPathChecker {
    ...
    private HashSet<X509CRL_YA> mPossibleCRLs;
    private HashSet<X509CRL_YA> mApprovedCRLs;
    ...
    private void verifyRevocationStatus(X509Certificate currCert,
        ...
        mPossibleCRLs = new HashSet<X509CRL_YA>();
        mApprovedCRLs = new HashSet<X509CRL_YA>();
        ...
        try {
            ...
            for (CertStore mStore : mStores) {
                for (java.security.cert.CRL crl : mStore.getCRLs(sel)) {
                    mPossibleCRLs.add((X509CRL_YA)crl);
                }
            }
        ...
        for (X509CRL_YA crl : mApprovedCRLs) {
            X509CRLEntry_YA e = crl.getRevokedCertificate(currCert);
            if (e != null) {
                try {
     ...
     */
    private Collection<X509CRL_YA> verifyPossibleCRLs(Set<X509CRL_YA> crls,
