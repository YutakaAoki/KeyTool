 ...
 *     X509CRL_YA crl = (X509CRL_YA)cf.generateCRL(inStream);
 * } finally {
 *     if (inStream != null) {
 *         inStream.close();
 *     }
...
public abstract class X509CRL_YA extends CRL implements X509Extension {
     ...
     * <code>instanceof</code> <code>X509CRL_YA</code>, then
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof X509CRL_YA)) {
            return false;
        }
        try {
            byte[] thisCRL = X509CRLImpl.getEncodedInternal(this);
            byte[] otherCRL = X509CRLImpl.getEncodedInternal((X509CRL_YA)other);
     ...
     * @see X509CRLEntry_YA
     */
    public abstract X509CRLEntry_YA
     ...
     * @since 1.5
     */
    public X509CRLEntry_YA getRevokedCertificate(X509Certificate certificate) {
     ...
     * This returns a Set of X509CRLEntry_YA objects.
     *
     * @return all the entries or null if there are none present.
     * @see X509CRLEntry_YA
     */
    public abstract Set<? extends X509CRLEntry_YA> getRevokedCertificates();
